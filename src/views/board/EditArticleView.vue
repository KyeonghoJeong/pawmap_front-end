    ...
    methods:{
        ...
        async updateArticle(){
            try{
                ...
                if(updateArticleResponse.data === 'invalidAccessToken'){
                    ...
                    if(getNewAccessTokenResponse.data === 'invalidRefreshToken'){
                        ...
                        if(reUpdateArticleResponse.data !== 'invalidAccessToken'){
                            // 게시글 수정 후 해당 게시글로 이동
                            this.$router.push({path: '/board', query: {articleId: this.articleId}});
                        }
                    }
                }else{
                    // 게시글 수정 후 해당 게시글로 이동
