        ...
        <div class="div-MyPage-tab">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item li-MyPage">
                    <span class="nav-link span-MyPage-tab" v-bind:class="{ active: activeTab === 'bookmark' }" @click="getComponent('bookmark')">북마크</span>
                </li>
                <li class="nav-item li-MyPage">
                    <span class="nav-link span-MyPage-tab" v-bind:class="{ active: activeTab === 'myArticles' }" @click="getComponent('myArticles')">내 게시글</span>
                </li>
                <li class="nav-item li-MyPage">
                    <span class="nav-link span-MyPage-tab" v-bind:class="{ active: activeTab === 'myInfo' }" @click="getComponent('myInfo')">회원정보</span>
                </li>
            </ul>
        </div>
