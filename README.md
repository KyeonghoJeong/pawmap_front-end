<h2><img src="https://github.com/KyeonghoJeong/pawmap_front-end/assets/128965451/477d5789-f58e-41ef-ad66-854f22bc8575" width="25"/> 반려동물 동반 가능 시설을 쉽게 찾을 수 있는 웹사이트 포맵</h2>
...
Select 메뉴를 통해 카테고리, 시도, 시군구, 읍면동을 조합하여 선택할 수 있으며 각 Select에서 항목을 선택할 때마다 선택한 조합에 해당하는 반려동물 동반 가능 시설을 지도와 마커, 목록으로 바로바로 확인할 수 있음<br>

마커를 클릭하거나 목록에서 카드 또는 상세보기를 클릭한 경우 해당 시설의 상세정보 및 반려동물 동반 관련 사항을 확인할 수 있음<br>

목록의 시설 카드 또는 지도의 마커 오버레이의 북마크 메뉴 클릭 시 해당 시설을 북마크에 추가할 수 있음 (로그인 필요)
...
아이디, 비밀번호, 닉네임, 이메일은 모두 길이 제한, 글자 제한이 있으며 이 제한을 지키지 않는 경우 회원가입이 불가함<br>
...
마이페이지의 회원정보 탭에서 회원 탈퇴 페이지로 이동할 수 있으며 비밀번호 입력을 통해 회원 탈퇴할 수 있음
